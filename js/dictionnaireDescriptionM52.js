...
var dictionnaireDescriptionM52 = {
    "0": "Les Services généraux sont des services pleins de généralité",
    "01": "Opérations non ventilables car on manque de ventilateurs",
    ...
    */
    ...
    "1": "Sécurité",
    "10": "Services communs",
    "12": "Incendie et secours Pim pon pim pon Pim pon pim pon Pim pon pim pon Pim pon pim pon Pim pon pim pon",
    /*
    ...
    */
    ...
    "5": "L'action sociale (hors RMI, APA, RSA) couvre l'ensemble des actions qui visent à compenser les inégalités de ce monde",
    "50": "Services communs",
    ...
    */
    ...
    "55": "Personnes dépendantes (APA) Allocations aux personnes âgées. Très important pour les gens qui n'ont plus la même capacité d'autonomie.",
    ...
    */
    ...
    "56": "RSA",
    "561": "Insertion sociale - parce qu'on n'a pas tous u boulot et que le chômage est structurel et va empirer dans les années à venir.",
    /*
    562 Santé
    563 Logement
